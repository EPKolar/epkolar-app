// EP Kolar Service Worker v3.5.185
const CACHE_NAME = "epkolar-v3.5.185";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.185: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
