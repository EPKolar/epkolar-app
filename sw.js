// EP Kolar Service Worker v3.5.192
const CACHE_NAME = "epkolar-v3.5.192";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.192: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
