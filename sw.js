// EP Kolar Service Worker v3.5.164
const CACHE_NAME = "epkolar-v3.5.164";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.164: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
