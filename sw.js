// EP Kolar Service Worker v3.7.11
const CACHE_NAME = "epkolar-v3.7.11";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.7.11: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
