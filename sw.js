// EP Kolar Service Worker v3.7.10
const CACHE_NAME = "epkolar-v3.7.10";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.7.10: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
