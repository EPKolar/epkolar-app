// EP Kolar Service Worker v3.5.175
const CACHE_NAME = "epkolar-v3.5.175";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.175: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
