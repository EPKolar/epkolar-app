// EP Kolar Service Worker v3.5.142
const CACHE_NAME = "epkolar-v3.5.142";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.142: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
