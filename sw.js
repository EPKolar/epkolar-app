// EP Kolar Service Worker v3.6.14
const CACHE_NAME = "epkolar-v3.6.14";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.6.14: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
