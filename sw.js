// EP Kolar Service Worker v3.5.191
const CACHE_NAME = "epkolar-v3.5.191";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.191: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
