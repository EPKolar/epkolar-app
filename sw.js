// EP Kolar Service Worker v3.5.147
const CACHE_NAME = "epkolar-v3.5.147";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.147: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
