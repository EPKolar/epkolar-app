// EP Kolar Service Worker v3.5.170
const CACHE_NAME = "epkolar-v3.5.170";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.170: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
