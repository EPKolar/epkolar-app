// EP Kolar Service Worker v3.5.189
const CACHE_NAME = "epkolar-v3.5.189";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.189: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
