// EP Kolar Service Worker v3.5.169
const CACHE_NAME = "epkolar-v3.5.169";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.169: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
