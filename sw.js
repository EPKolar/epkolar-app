// EP Kolar Service Worker v3.5.161
const CACHE_NAME = "epkolar-v3.5.161";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.161: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
