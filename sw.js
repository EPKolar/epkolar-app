// EP Kolar Service Worker v3.5.156
const CACHE_NAME = "epkolar-v3.5.156";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.156: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
