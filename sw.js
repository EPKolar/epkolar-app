// EP Kolar Service Worker v3.7.17
const CACHE_NAME = "epkolar-v3.7.17";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.7.17: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
