// EP Kolar Service Worker v3.5.173
const CACHE_NAME = "epkolar-v3.5.173";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.173: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
