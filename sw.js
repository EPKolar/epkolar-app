// EP Kolar Service Worker v3.6.13
const CACHE_NAME = "epkolar-v3.6.13";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.6.13: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
