// EP Kolar Service Worker v3.5.187
const CACHE_NAME = "epkolar-v3.5.187";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.187: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
