// EP Kolar Service Worker v3.5.165
const CACHE_NAME = "epkolar-v3.5.165";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.165: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
