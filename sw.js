// EP Kolar Service Worker v3.5.186
const CACHE_NAME = "epkolar-v3.5.186";
const ASSETS = [
  './',
  './index.html'
];
...
self.addEventListener('install', event => {
  // v3.5.186: matchAll({includeUncontrolled:true}) — während install hat SW KEINE controlled clients
